...
@ApplicationScoped
@Startup
public class ParentTeamRolesSeedMigration {

    private static final String MIGRATION_ID = "seed-parent-team-roles-v1";
    ...
    void onStart(@jakarta.enterprise.event.Observes io.quarkus.runtime.StartupEvent ev) {
        ...
        if (orgColl.find(new Document("tag", "parent-team-roles")).first() == null) {
            orgColl.insertOne(new Document()
                    .append("tag", "parent-team-roles")
